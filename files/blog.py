...
blog.py
-------
Standard Flaskr blog blueprint with one addition for Stage 1:
after a post is successfully created, fire_webhook() notifies Make,
which cross-posts to LinkedIn and sends a Slack notification.

Search for "# STAGE 1" to find the two lines that were added.
"""
